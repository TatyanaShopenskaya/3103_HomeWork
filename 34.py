    ...
    for word in list_1:
        ...
        for letter in word:
            if letter in 'аеёиоуыэюя':
                counter += 1
        array_counter.append(counter)
    print(array_counter) 
    return len(array_counter) == array_counter.count(array_counter[0])    # count возвращает количество раз, когда появляется указанное значение 
 

int = input('Напишите стих - ')
if rhythm(int):
    print('Парам пам-пам')
else:
    print('Пам парам')